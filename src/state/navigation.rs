...
pub struct CurrentLocation {
    pub docked: bool,
    pub station_name: Option<Box<str>>,
    pub station_type: Option<Box<str>>,
    pub station_faction: Option<SystemFaction>,
    pub station_government: Option<Box<str>>,
    pub station_services: Option<Vec<Box<str>>>,
    pub station_economy: Option<Box<str>>,
    ...
    pub system_economy: Box<str>,
    pub system_second_economy: Box<str>,
    pub system_government: Box<str>,
    ...
    pub powers: Option<Vec<Box<str>>>,
    pub powerplay_state: Option<Box<str>>,
...
pub struct Faction {
    pub name: Box<str>,
    pub faction_state: Box<str>,
    pub government: Box<str>,
    pub influence: f64,
    pub allegiance: Box<str>,
    pub happiness: Box<str>,
...
pub struct SystemFaction {
    pub name: Box<str>,
    pub faction_state: Option<Box<str>>,
}
