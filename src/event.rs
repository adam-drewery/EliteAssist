...
pub enum JournalEvent {
    ...
    SwitchSuitLoadout(inventory::SuitLoadout),
    ...
    MissionFailed(personal::Mission),
    SupercruiseDestinationDrop(SupercruiseDestinationDrop),
    MissionAbandoned(personal::Mission),
    ...
    CreateSuitLoadout(inventory::SuitLoadout),
    ...
    BuyWeapon(BuyWeapon),
    RenameSuitLoadout(inventory::SuitLoadout),
