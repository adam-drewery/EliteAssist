...
pub fn material_to_locations(material_name: &str) -> Vec<String> {
    get_items(&MATERIAL_LOCATIONS, material_name)
}

pub fn item_to_locations(material_name: &str) -> Vec<String> {
    get_items(&ITEM_LOCATIONS, material_name)
}
